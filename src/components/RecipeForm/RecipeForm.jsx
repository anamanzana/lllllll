...
import createRecipe from '../../services/createRecipe'; // Import the createRecipe service
...
const RecipeForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const newRecipe = {
      ...
      preparation_time_in_minutes: parseInt(preparationTime, 10), // New: Convert preparation time to a number
    };
